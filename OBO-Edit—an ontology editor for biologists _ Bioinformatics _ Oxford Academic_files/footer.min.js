...
SCM.JumpLinks = (function($){
    ...
    */
    return {
        init: init,
        registerEndNotesTocLink: registerEndNotesTocLink
    }
    ...
    */
    function registerEndNotesTocLink() {
        $('.js-notes-link').on('click', function () {           
            var targetOffsetTop = $('#endNotesTargetLocation').offset().top - 50;
            $body.animate({
                scrollTop: targetOffsetTop
            }, 400, function () {
                $(window).off('scroll', handleScroll);
    ...
    function registerFootNotesLink() {
        ...
        $(".js-end-note-link").on('click', function (e) {
            var footnoteId = $(this).attr('fn-id');
            var bookId = $("#bookId").val();
            if (footnoteId.length && bookId.length) {
                // If it's on this page don't need 
                // to find the chapter on the server side
                var $relatedObject = $('.js-related-object[legacysectionid="' + footnoteId + '"]:first');
                if ($relatedObject.length) {
                    // need to account for sticky toolbar
                    var targetOffsetTop = $relatedObject.offset().top - 60;
                    $body.animate({
                        scrollTop: targetOffsetTop
                    }, 200, function () {
                        $(window).off('scroll', handleScroll);
        ...
        $(window).on('scroll', function () {
            ...
            if ($('.book-chapter-body').length) {
                ...
                $($jsJumpLinkTargetIds).each(function () {
                    ...
                    if ($(this).hasClass('js-end-notes-target')) {
